      ...
      case "textarea":
        return (
          <Textarea
            value={String(value ?? "")}
            onChange={(e) =>
              handleIntakeFieldChange(field.slug, e.target.value)
            }
          ...
          <div className="flex items-center gap-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                handleIntakeFieldChange(field.slug, checked)
              }
            />
        ...
        <Card>
          ...
          <CardContent>
            {signatureRequests.length > 0 ? (
              ...
              <p className="text-sm italic text-muted-foreground/70 py-2 text-center">
      ...
      <Dialog open={convertOpen} onOpenChange={setConvertOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This will create a new case for {lead.firstName} {lead.lastName}{" "}
              and mark this lead as converted. A contact record will be created
              automatically.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4 space-y-4">
            ...
            <div className="rounded-md bg-muted p-3 text-sm">
              ...
              <ul className="mt-2 space-y-1 text-muted-foreground list-disc list-inside">
                <li>
                  A new contact record for {lead.firstName} {lead.lastName}
                </li>
