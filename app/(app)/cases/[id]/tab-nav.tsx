...
export function CaseTabNav({ caseId }: { caseId: string }) {
  ...
  return (
    <nav className="flex gap-1 border-b border-[#EAEAEA] overflow-x-auto bg-background">
      {tabs.map((tab) => {
        ...
        return (
          <Link
            ...
            href={href}
            className={cn(
              "px-3 py-2 text-sm font-medium whitespace-nowrap -mb-px border-b-2 transition-colors duration-200",
              isActive
