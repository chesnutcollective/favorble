...
export function QueueClient({
  ...
  const baseTasks: QueueTask[] =
    queueMode === "team" ? teamTasks : initialTasks;
  ...
  function handleSnooze(
    option: "tomorrow" | "next_week" | "custom",
    customDate?: string,
  ) {
    if (!selectedTask) return;
    let newDate: string;
  ...
  const handleKeyDown = useCallback(
    (e: KeyboardEvent) => {
      ...
      if (e.key === "j") {
        ...
        e.key === "x" &&
        focusedIndex >= 0 &&
        focusedIndex < filteredTasks.length
      ) {
        e.preventDefault();
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList>
            ...
            <TabsTrigger value="no_date">No Date {counts.noDate}</TabsTrigger>
          </TabsList>
        </Tabs>
      ...
      <div className="flex items-center gap-4 text-xs text-muted-foreground flex-wrap">
        <span>
          ...
          <kbd className="rounded border bg-muted px-1 py-0.5 font-mono text-[10px] ml-0.5">
            k
          </kbd>{" "}
          navigate
        </span>
      ...
      {/* Task Detail Sheet */}
      <Sheet
        open={!!selectedTask && !reassignOpen && !snoozeCustomOpen}
          ...
          {selectedTask && (
            <>
              <SheetHeader>
                ...
                <SheetDescription>
                  {selectedTask.caseNumber} &middot;{" "}
                  {selectedTask.stageName ?? "No stage"}
                </SheetDescription>
              </SheetHeader>
