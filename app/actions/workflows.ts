...
export async function getWorkflowTemplates() {
	...
	const workflows = await db
		...
		.leftJoin(
			caseStages,
			eq(workflowTemplates.triggerStageId, caseStages.id),
		)
...
export async function updateWorkflowTemplate(
	...
	if (data.triggerStageId !== undefined) updateData.triggerStageId = data.triggerStageId;
	if (data.notifyAssignees !== undefined) updateData.notifyAssignees = data.notifyAssignees;
	if (data.notifyCaseManager !== undefined) updateData.notifyCaseManager = data.notifyCaseManager;
